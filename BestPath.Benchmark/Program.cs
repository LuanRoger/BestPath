...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        Summary sumary = BenchmarkDotNet.Running.BenchmarkRunner.Run<Program>(config);
    }
    
    [Benchmark]
    public void CreateDfsGraphAndRun()
    {
        DfsGraph graph = new();
